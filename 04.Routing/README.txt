...
3. src/03: React Router Basic III: HashRouter & BrowserRouter
4. src/04: React Router Basic V: Link VS NavLink
5. src/05: Styling & Semantic Markup
6. src/06: Composition ({children})
7. src/07: useRoutes Hook
